...
Test(basecode_tests_suite, validargs_help_test, .timeout=10) {
    int argc = 2;
...
Test(basecode_tests_suite, validargs_generate_test, .timeout=10) {
    char *nfile = "noise.au";
    int argc = 4;
...
Test(basecode_tests_suite, validargs_detect_test, .timeout=10) {
    int argc = 4;
...
Test(basecode_tests_suite, validargs_error_test, .timeout=10) {
    int argc = 4;
...
Test(basecode_tests_suite, help_system_test, .timeout=10) {
    char *cmd = "bin/dtmf -h > /dev/null 2>&1";
...
Test(basecode_tests_suite, goertzel_basic_test, .timeout=10) {
    int N = 100;
    int k = 1;
