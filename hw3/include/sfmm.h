...
/*
    ...
    |                                       (1 rows)                                          |
    +---------------------------------------------------+--------+--------+---------+---------+ <- header
    |                     block_size                    | unused |in qklst|prv alloc|  alloc  |
    |                (4 LSB's implicitly 0)             |  (0)   |  (0)   |   (0)   |   (1)   | prologue
    |                      (1 row)                      | 1 bit  | 1 bit  |  1 bit  |  1 bit  |
    +---------------------------------------------------+--------+--------+---------+---------+ <- (aligned)
    |                                                                                         |
    |                                        Padding                                          |
    ...
    +---------------------------------------------------+--------+--------+---------+---------+ <- header
    |                     block_size                    | unused |in qklst|prv alloc|  alloc  |
    |                (4 LSB's implicitly 0)             |  (0)   | (0/1)  |   (1)   |  (0/1)  | first block
    |                      (1 row)                      | 1 bit  | 1 bit  |  1 bit  |  1 bit  |
    +---------------------------------------------------+--------+--------+---------+---------+ <- (aligned)
    |                                                                                         |
    |                                   Payload and Padding                                   |
    ...
    +---------------------------------------------------+--------+--------+---------+---------+ <- footer
    |                     block_size                    | unused |in qklst|prv alloc|  alloc  |
    |                (4 LSB's implicitly 0)             |  (0)   | (0/1)  |   (1)   |  (0/1)  |
    |                      (1 row)                      | 1 bit  | 1 bit  |  1 bit  |  1 bit  |
    +---------------------------------------------------+--------+--------+---------+---------+
    |                                                                                         |
    |                                                                                         |
